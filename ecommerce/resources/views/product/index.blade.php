                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="{{ url('product/'.$product->id) }}">
                                            <img src="{{ $product->getImage->first()->getLogo() }}" alt="Product image" class="product-image">
                                        </a>
                                        @else
                                        <a href="{{ url('product/'.$product->id) }}">
                                            <img src="{{ asset('./upload/default.jpg') }}" alt="Default image" class="product-image">
                                        </a>
                                        @endif

                                        <div class="product-action-vertical">
                                            <!-- Các nút thêm vào yêu thích, xem nhanh, so sánh -->
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            ...
                                            <a href="#">
                                                <img src="{{ $image->getLogo() }}" alt="Product Image">
                                            </a>
                                            @endforeach
                                        </div><!-- End .product-nav -->
                                        @endif
