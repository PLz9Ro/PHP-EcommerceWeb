  ...
  <div class="container-fluid">
    <div class="row">
      <div class="card-header">
        <h1 class="card-title">Create Color</h1>
      </div>
      <div style="text-align:right;" class="col-sm-12  pl-4">
        <a href="{{ url('admin/color') }}" class="btn btn-info">Back</a>
      </div>
    </div>
              ...
              <form id="quickForm" action="" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="name" name="name" class="form-control" value="{{ old('name') }} " id="name" placeholder="Enter Name Of Color">
                    <div style="color:red;">{{ $errors->first('name') }}</div>
                  </div>
                  <div class="form-group">
                    <label for="code">Color Code </label>
                    <input type="color" name="code" class="form-control" value="{{ old('code') }}" id="code" placeholder="Enter Color Code">
                  </div>
                  <div class="form-group">
